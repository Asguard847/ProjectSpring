...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <a href="${pageContext.request.contextPath}/admin/buses/addBus" class="btn btn-primary"><fmt:message key = "button.add"/></a>
        </div>
        ...
        <table class="table table-striped table-hover">
            ...
            <c:forEach items="${buses}" var="bus">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/admin/buses/deleteBus/${bus.id}">
                            <button type="button" class="btn btn-danger"><fmt:message key = "button.delete"/></button></a>
                        <a href="${pageContext.request.contextPath}/admin/buses/editBus/${bus.id}">
